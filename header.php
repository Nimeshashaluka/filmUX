        ...
        <div class="row">
            <div class="nav-bar">
                <nav class="col-12">
                    ...
                    <ul class="sidebar">
                        <li onclick="hideSidebar();"><a href="#"><img src="images/103431_cancel_icon.png" id="hide"></a>
                        </li>
                ...
                <div class="col-12 home-title">
                    <h3>The FILM UX</h3>
                    <p>Film UX offers a user-friendly platform for streaming the latest movies. <br />
                        With a sleek interface and diverse catalog, it provides an enjoyable <br />
                        viewing experience for cinephiles worldwide.</p>
                </div>
                <div class="col-12 home-btn ">
                    <button onclick="NewArrivalBtn();" class="home-arrival-btn d-none d-lg-block d-md-block">New
                        Arrival</button>
                    <button onclick="contactPageCh();"
                        class="home-about-btn d-none d-lg-block d-md-block">Contact</button>
                </div>
            </div>
